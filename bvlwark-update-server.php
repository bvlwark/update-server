...
if ( ! defined( 'BVLWARK_UPDATE_SERVER_PLUGIN_VERSION' ) ) {
	define( 'BVLWARK_UPDATE_SERVER_PLUGIN_VERSION', '0.1.0' );
}

// Define BVLWARK_UPDATE_SERVER_PLUGIN_FILE.
if ( ! defined( 'BVLWARK_UPDATE_SERVER_PLUGIN_FILE' ) ) {
	define( 'BVLWARK_UPDATE_SERVER_PLUGIN_FILE', __FILE__ );
}

// Define BVLWARK_UPDATE_SERVER_PLUGIN_DIR.
if ( ! defined( 'BVLWARK_UPDATE_SERVER_PLUGIN_DIR' ) ) {
	define( 'BVLWARK_UPDATE_SERVER_PLUGIN_DIR', __DIR__ );
}

// Define BVLWARK_UPDATE_SERVER_PLUGIN_URL.
if ( ! defined( 'BVLWARK_UPDATE_SERVER_PLUGIN_URL' ) ) {
	define( 'BVLWARK_UPDATE_SERVER_PLUGIN_URL', plugins_url( '', __FILE__ ) . '/src/' );
}
