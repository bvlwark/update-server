...
current_version=$(cat bvlwark-update-server.php | grep -o -P 'Version: ^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$')

# Replace the version in the plugin file
sed -i "s/Version: $current_version.*/Version: $new_version/g" bvlwark-update-server.php
